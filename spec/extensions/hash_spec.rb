...
describe Hash, '#deep_find basic lookup' do
  subject(:hash) do
    {
      key1: 'value1',
      key2: {
...
describe Hash, '#deep_find with array containing hashes' do
  subject(:hash) do
    {
      items: [
        { id: 1, name: 'foo' },
...
describe Hash, '#deep_find with nil values' do
  it 'returns nil' do
    expect({ a: nil }.deep_find(:a)).to be_nil
  end
end

describe Hash, '#deep_find with array' do
...
describe Hash, '#deep_find with integer key' do
...
describe Hash, '#deep_find with empty hash' do
  it 'returns nil' do
    expect({}.deep_find(:anything)).to be_nil
  end
end

describe Hash, '#deep_find with empty array' do
  it 'returns nil' do
