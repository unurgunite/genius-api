...
describe Genius::Artists, ' .artists with valid data' do
  let(:token) { 'a' * 64 }
...
describe Genius::Artists, ' .artists with nil id' do
  let(:token) { 'a' * 64 }
  let(:artist_id) { 16_764 }
...
describe Genius::Artists, ' .artists_songs with valid data' do
  let(:token) { 'a' * 64 }
  let(:artist_id) { 16_764 }
  let(:response_body) do
    {
...
describe Genius::Artists, ' .artists_songs with sort option' do
  let(:token) { 'a' * 64 }
  let(:artist_id) { 16_764 }
...
describe Genius::Artists, ' .artists_songs with invalid sort' do
  let(:token) { 'a' * 64 }
  let(:artist_id) { 16_764 }
...
describe Genius::Artists, ' .artists_songs with negative per_page' do
  let(:token) { 'a' * 64 }
  let(:artist_id) { 16_764 }
...
describe Genius::Artists, ' .artists_songs with negative page' do
  let(:token) { 'a' * 64 }
  let(:artist_id) { 16_764 }
...
describe Genius::Artists, ' .artists_songs without token' do
  let(:artist_id) { 16_764 }
